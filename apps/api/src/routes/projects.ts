...
projectRoutes.get('/projects', async (c) => {
  ...
  return c.json({
    projects: (results ?? []).map((p: any) => ({
      ...
      auditorPhone: p.auditor_phone,
      auditorQualifications: p.auditor_qualifications,
      firmAddress: p.firm_address,
      firmEmail: p.firm_email,
      firmPhone: p.firm_phone,
      firmWebsite: p.firm_website,
...
projectRoutes.put('/projects/:projectId', zValidator('json', updateProjectSchema), async (c) => {
  ...
  const fieldMap: Record<string, string> = {
    ...
    auditorEmail: 'auditor_email', auditorPhone: 'auditor_phone',
    auditorQualifications: 'auditor_qualifications',
    firmAddress: 'firm_address', firmEmail: 'firm_email',
    firmPhone: 'firm_phone', firmWebsite: 'firm_website',
